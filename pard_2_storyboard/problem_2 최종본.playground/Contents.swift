...
let today = sunday_to_saturday.Friday
print("Today is \(today), raw value: \(today.rawValue)")
...
//
func printArea(_ width: Double, height: Double){
...
// ---------- Mark : function guard문 사용 답안 작성란 ----------------
    func checkLoginStetus(login: Bool, userName:String?){
        guard login else{
            print("로그인이 필요합니다. ")
            return
        }
